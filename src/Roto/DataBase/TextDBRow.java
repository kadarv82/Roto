...
public class TextDBRow {
	...
	public boolean isRight() {
		if (getDirection().toLowerCase().trim().equalsIgnoreCase("r")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isLeft() {
		if (getDirection().toLowerCase().trim().equalsIgnoreCase("l")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isCilinder() {
		if (getColor().toLowerCase().trim().equalsIgnoreCase("c")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isHandle() {
		if (getDirection().toLowerCase().trim().equalsIgnoreCase("k")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isHandleGarniture() {
		if (getDirection().toLowerCase().trim().equalsIgnoreCase("g")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isLiftingMD() {
		if (getColor().toLowerCase().trim().equalsIgnoreCase("h")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isCatchNormal() {
		if (getColor().toLowerCase().trim().equalsIgnoreCase("cs")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isCatchMagnet() {
		if (getColor().toLowerCase().trim().equalsIgnoreCase("mcs")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isFan() {
		if (getColor().toLowerCase().trim().equalsIgnoreCase("r")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isPullHandle() {
		if (getLock().toLowerCase().trim().equalsIgnoreCase("kh")) {
			return true;
		} else {
			return false;
		}
	...
	public boolean isColor() {
		...
		for (int i=0; i < swc.colorArray.length; i++) {
			if (getColor().toLowerCase().trim().equalsIgnoreCase(swc.colorArray[i].toLowerCase().trim())) {
				isColor = true;
			}
		}
		return isColor;
	...
	public boolean isCloasbleBar() {
		...
		for (int i=0; i < swc.closableBarArray.length; i++) {
			if (getLock().toLowerCase().trim().equalsIgnoreCase(swc.closableBarArray[i].toLowerCase().trim())) {
				isClosabeBar = true;
			}
		}
		return isClosabeBar;
	...
	public boolean isSelectionBar() {
		...
		for (int i=0; i < swc.selectionBarArray.length; i++) {
			if (getColor().toLowerCase().trim().equalsIgnoreCase(swc.selectionBarArray[i].toLowerCase().trim())) {
				isSelectionBar = true;
			}
		}
	...
	public boolean isElolapDornos() {
		return getLock().toLowerCase().trim().equalsIgnoreCase("ed");
	}

	public boolean isNormalBar() {
		if (getLock().toLowerCase().trim().equalsIgnoreCase("0")) {
			return true;
		}
		return false;
	}
