...
public class DataBaseCollection {
    ...
    public void addRows() {
        ...
        for (int i = 0; i < key.length; i++) {
            ...
            tableModel.addRow(new Object[] { selection.get(SAP).toString(), SAP, priceUtil.getListText(SAP),
        ...
        //Add summary
        if (key.length > 0) {
            frames.tfCollectionSum.setText(formatter.format(formatDouble(getNetSum())) + " " + priceUtil.getCurrency() +
