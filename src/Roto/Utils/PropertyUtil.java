...
public class PropertyUtil {
    ...
    private static final Charset ch_utf8 = Charset.forName("UTF-8");
    private static final Charset ch_8859_1 = Charset.forName("8859_1");

    //Relative properties
    private static final String BASE_PROPERTY_PATH = "Roto.properties";
    private static final String FRAME_PROPERTY_PATH = "Frames.properties";
    private static final String DATABASELIST_PROPERTY_PATH = "DatabaseList.properties";
    private static final String BASE_PROPERTY_NAME = "Base";
    private static final String FRAME_PROPERTY_NAME = "Frame";
    private static final String DATABASELIST_PROPERTY_NAME = "DatabaseList";

    //Fix properties
    private static final String LANG_PROPERTY_PATH = "Bin/Properties/Basic/Language.properties";
    private static final String PROFILES_PROPERTY_PATH = "Bin/Properties/Basic/Profiles.properties";
    private static final String USERS_PROPERTY_PATH = "Bin/Properties/Basic/Users.properties";
    private static final String DATABASE_PROPERTY_PATH = "Bin/Properties/Basic/Database.properties";
    private static final String PRICELIST_PROPERTY_PATH = "Bin/Properties/Basic/Pricelist.properties";

    private static final String LANG_PROPERTY_NAME = "Lang";
    private static final String PROFILES_PROPERTY_NAME = "Profiles";
    private static final String USERS_PROPERTY_NAME = "Users";
    private static final String DATABASE_PROPERTY_NAME = "Database";
    private static final String PRICELIST_PROPERTY_NAME = "Pricelist";
    ...
    private void init() {
        ...
        //Add languages
        for (int i = 0; i < SwingConstans.getInstance()
                                         .langCodes
                                         .length; i++) {
    ...
    public void createLanguageProperties(String folderToCreate) {
        ...
        StringReader reader =
            new StringReader(IOUtil.getInstance()
                             .loadUTF8(SwingConstans.getInstance().basicPath + "/Language_hu.properties"));
        ...
        for (int i = 0; i < SwingConstans.getInstance()
                                         ...
                                         .length; i++) {
            File langFile =
                new File(folderToCreate + "/Language_" + SwingConstans.getInstance().langCodes[i] + ".properties");
            if (!langFile.exists()) {
