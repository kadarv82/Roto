...
public class SystemUtil {
    ...
    private void debugProperties() {
        Iterator it = System.getProperties()
                            .keySet()
                            .iterator();
        while (it.hasNext()) {
    ...
    public String getJavaInfo() {
        ...
        String[] keys = {
            "java.runtime.name", "sun.boot.library.path", "java.vm.version", "java.vm.vendor", "java.vendor.url",
            "user.country", "java.runtime.version", "os.name", "os.version", "sun.jnu.encoding", "file.encoding",
            "java.home", "user.language", "java.version"
        };
