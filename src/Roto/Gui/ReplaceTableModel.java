...
public class ReplaceTableModel extends DefaultTableModel implements ActionListener, MouseListener, KeyListener {

    private static final long serialVersionUID = -6772240413179007369L;
        ...
        if (e.getSource().getClass() == JRNumberTextField.class) {
            if (e.getClickCount() > 1) {
                ...
                Frames.getInstance()
                      ...
                      .setActionCommand("replacedatasetsap");
            }
