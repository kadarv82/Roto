...
public class CheckRenderer extends JPanel implements TreeCellRenderer {
	...
	public Component getTreeCellRendererComponent(JTree tree, Object value,
		...
		if (checkNode.getFontColor() != null) label.setForeground(checkNode.getFontColor());
		...
		if (leaf) {
			...
			if (checkNode.getImageIconDefault() != null) label.setIcon(checkNode.getImageIconDefault());
		} else if (expanded) {
			label.setIcon(UIManager.getIcon("Tree.openIcon"));
			if (checkNode.getImageIconOpened() != null) label.setIcon(checkNode.getImageIconOpened());
		} else {
			label.setIcon(UIManager.getIcon("Tree.closedIcon"));
			if (checkNode.getImageIconClosed() != null) label.setIcon(checkNode.getImageIconClosed());
		}
