...
public class Frames  extends JInternalFrame implements InternalFrameListener, ActionListener, 
MouseListener, ListSelectionListener, DragSourceListener, DragGestureListener, KeyListener{
	...
	public JRInternalFrame jriMenus,jriPriceListView,jriPriceListSelect,jriMaterialGroups,jriDbListEditor, jriRebate,
							jriAdminLogin,jriWindows,jriCollectionList,jriCollectionEdit,jriExcelList,
							jriEditDataBase,jriReplaceData,jriCurrency,jriItemList,jriLanguages,
							jriLanguagesEdit,jriRegister,jriRegisterInfo,jriCorrection,jriProfiles,
							jriFontSize,jriAbout;
	public JMenuBar mainMenuBar;
	public JRMenu jmDb,jmEdit,jmExit,jmList,jmOptions,jmProtection,jmView,
		   jmPrintPreview,jmPrint,jmRegister,jmTypes,jmAdmin,jmListSave,jmListSaveExcel;
	public JRMenuItem  jmiOpen,jmiClose,jmiStockList,jmiLang,jmiExit,jmiExitSave,
				jmiOpenEdit,jmiOpenNewDb,jmiCloseDb,jmiSave,jmiSaveAs,jmiSaveExcel,
				jmiReplaceData,jmiListDelete,jmiListDetailedSave,jmiListSummarizedSave,
				jmiListDetailedSaveExcel,jmiListSummarizedSaveExcel,jmiListGarnitureSaveExcel,
				jmiListNavisonSave,jmiListOpen,jmiLanguage,jmiCorrection,jmiPricelist,jmiCurrency,
				jmiRabate,jmiGroups, jmiTypes, jmiMenus, jmiListProjectSave,
				jmiItems,jmiPrintPreviewSummarized,jmiPrintPreviewDetailed,jmiPrintPreviewGarniture,
				jmiProjectDatabase,jmiPrintDetailed,jmiPrintProject,jmiPrintGarniture,
				jmiRegisterData,jmiRegisterProgram,jmiFontSize,jmiDataBaseList,jmiEditDataBaseList,
				jmiAdminLogin,jmiAdminLogout,jmiListDetailedConcat,jmiProfiles;
	public JRMenuItem jmiColorNone,jmiColorWhite,jmiColorBrown,jmiColorNatureSilver,jmiColorNewSilver,
				jmiColorGold,jmiColorMatGold,jmiColorBrass,jmiColorTitan,jmiColorOliveBrown,
				jmiColorGreyBrown,jmiColorMiddleBrass,jmiColorDarkBrass, jmiColorCreamWhite,
				jmiColorJetBlack, jmiProfileNewUser,jmiProfileNew,jmiProfileModify,jmiProfileDelete,
				jmiAdminProfiles,jmiAdminLang,jmiAdminReplaceData,jmiAdminTypes,jmiAbout,
				jmiBarKo,jmiBarKsr,jmiBarM,jmiNTn3,jmiNTn6,jmiNXx3,jmiNXx6,jmiNXxe;

	public ToolBarButton tbLeft,tbRight,tbOver,tbCatch,tbCatchMagnet,tbMDK, tbMDF, tbMDS, tbMKIPP,
						tbMDK2, tbMDF2, tbMDS2, tbMFREI, tbMDSMDK2,tbMDSMDF2,tbBar,tbClosableBar,
						tbSelectionBar,tbCatchNone,tbHandle,tbLiftingMD,tbFan,tbCilinder,tbViewer,
						tbNX,tbNT;
	public JTextField tfProfile,tfUser,tfPriceListName,tfGroup,tfGroupName,tfAdminFileName,
					  tfFilterText,tfRebateFileName,tfWindowTypes,tfCurrency,tfMainSumPrice,
					  tfKey1,tfKey2,tfKey3,tfCode1,tfCode2,tfCode3,tfRegCompany,tfRegAddress,
					  tfRegOperator,tfRegEmail,tfRegSalesRep,tfRegComment, tfRegCompanyTitle,
					  tfRegAddressTitle, tfRegOperatorTitle, tfRegEmailTitle, tfRegSalesRepTitle, 
					  tfRegCommentTitle,tfExportDirectory, tfSubDirectory, tfProfilesInput,
					  tfRebateProfileLocation, tfCollectionSum;
	public ButtonGroup groupDirection,groupBar,groupCatch,groupTypes,groupMenuBar,groupFlags,
						groupNTNX;
	public JTabbedPane jtpLogin;
	public JPanel pnMainLeft,pnMainTop,pnLoginTab,pnLogin,pnResize,pnDatabases,pnDataBaseButtons,
					pnRebateAdmin,pnHeaderSelector;
	public JToolBar jtTopLeftToolBar,jtTopCenterToolBar,jtTopRightToolBar,jtLeftToolBar;
	public JButton jbLogin,jbLogout,jbMenus,jbMenuSave,jbColors,jbPriceListOpen,jbPriceListSave,
			jbGroupModify,jbGroupAdd,jbGroupDelete,jbGroupNameModify,jbGroupNameAdd,jbGroupNameDelete,
			jbGroupSave,jbGroupReload,jbMoveLeft,jbMoveLeftAll,jbMoveRight,jbMoveRightAll,
			jbDbListBrowse,jbDbListOpen,jbCustomPriceListAdd,jbCustomPriceListRemove,jbPriceListFilter,
			jbPriceListFilterAdd,jbAdminRebateSave,jbAdminRebateOpen,jbRebateSave,jbAdminLogin,
			jbAdminLogout,jbWindowsAdd,jbWindowsModify,jbWindowsDelete,jbWindowsSave,jbWindowsLeft,
			jbWindowsRight,jbAddCollection,jbRemoveCollection,jbCollectionEditAdd,jbCollectionEditRemove,
			jbCollectionRemove,jbCollectionEditIncrease,jbCollectionEditDecrease,jbSaveExcelList,jbPrintExcelList,
			jbEditDbClearSorter,jbEditDbAddItem,jbEditDbRemoveItem,jbEditDbMoveUp,jbEditDbMoveDown,jbEditDbSave,
			jbEditDbSaveAs,jbEditDbSaveExcel,jbEditDbOpen,jbEditDbNew,jbEditDbClose,jbOpenDb,jbOpenListDb,
			jbReplaceDataAdd,jbReplaceDataRemove,jbReplaceListAdd,jbReplaceListRemove,jbReplace,jbCurrencySave,
			jbPriceListCurrency,jbStockRemoveItem,jbStockAddItem,jbStockAddFile,jbStockRemoveFile,jbStockListOpen,
			jbStockListSave,jbStockListCollect,jbStockListCollectDelete,jbStockListPrint,jbStockListSaveExcel,
			jbLanguagesSave,jbLanguageShowEmpty,jbLanguageEditorAdd,jbLanguageEditorSave,jbRegisterSaveForm,jbRegisterOpenForm,
			jbRegisterDemo,jbRegisterNewKey,jbRegisterExit,jbRegister,jbCorrectionSave,jbProfileAssembly,
			jbProfileExport,jbExportDirectory,jbRebateTreeSet,jbRebateTreeOpen,jbRebateTreeDelete,
			jbFontSizeSave, jbLoginStatus;
	public JCheckBox jcHandle,jcLiftingMD,jcCatch,jcFan,jcColor,jcCilinder,jcDbEditDeleteConfirm,
			jcStockItemDeleteConfirm,jcStockFileDeleteConfirm;
	public JRadioButton jrNormalCatch,jrMagnetCatch,jrLeft,jrRight,jrOver,jrBar,jrClosableBar,jrOrder,jrOffer,
						jrReplaceSAP,jrReplaceText,
						jrPrintSap = new JRadioButton("SAP", true),
						jrPrintMartikel = new JRadioButton("Martikel");
	public JLabel jlLogin,jlPc,jlWindowReview, jlEditingDbName, jlMainDatabaseName, jlLanguageLeft,jlLanguageRight,
				  jlExportLoaderLabel,jlRotoIcon;
	public JTabbedPane mainTabPane, windowTabPane;
	public JComboBox jcbBar,jcbColors,jcbProfiles,jcbAdminLogin,jcbAdminProfiles,jcbWinowTypes,jcbWinowSystems,
					 jcbEditDatabaseTyes,jcbCurrency,jcbLanguageLeft,jcbLanguageRight,jcbFontSize,jcbSelectionBar;
	public JPopupMenu jpBar,jpSelectionBar,jpColors,jpProfiles,jpProfilesInput,jpNT,jpNX;
	public JTable jtCollection,jtPriceListView,jtPriceListSelect,jtCustomPriceList,jtRebate,jtRebateGroups,jtWindows,
				  jtCollectionList,jtCollectionEdit,jtExcelList,jtExcelHeader,jtEditDataBase,jtReplaceData,
				  jtStockList,jtLanguagesEdit,jtWindowLimits;
	public DefaultTableModel tmCollection,tmPriceListView,tmPriceListSelect,tmCustomPriceList,tmRebate,tmRebateGroups,tmWindows,
							 tmCollectionList,tmCollectionEdit,tmExcelList,tmExcelHeader,tmStockList,
							 tmLanguagesEdit;
	public DataBaseTableModel tmdbEditDataBase;
	public ReplaceTableModel tmrReplaceData;
	public JRNumberTextField jntWidth,jntWidth2,jntHeight,jntHeight2,jntCorrectionWidth,jntCorrectionHeight,jntMultiplier,
							 jntFilterSAP,jntGarniture,jntCorrectionSaveWidth,jntCorrectionSaveHeight;
	public DefaultListModel dlGroups,dlGroupNames, dlDatabases, dlDatabaseFilter,dlRebate,dlCustomPriceList,
							dlCollectionEdit,dlReplaceFiles,dlStockFiles;
	public JList jlGroups,jlGroupNames,jlDatabases,jlDatabaseFilter,jlRebate,jlCustomPriceList,jlCollectionEdit,
				 jlReplaceFies,jlStockFiles;
	...
	public CheckNode nodeRoot, nodeRootDirection, nodeLeft,	nodeRight, nodeOver, nodeRootHandle, nodeHandleYes,
			nodeHandleNo, nodeRootLiftingMd, nodeLiftingMdYes, nodeLiftingMdNo, nodeRootCatch, nodeCatchNone,
			nodeCatchNormal, nodeCatchMagnet, nodeRootFan, nodeFanYes, nodeFanNo, nodeRootBar, nodeNormalBar,
			nodeRootClosableBar, nodeRootCilinder, nodeCilinderYes,	nodeCilinderNo,	nodeRootColor,
			nodeRootColumn,nodeMDK,nodeMDS,nodeMDF,nodeMKIPP,nodeMDK2,nodeMDS2,nodeMDF2,nodeMFREI;
	public CheckNode nodeRootProfiles,nodeRootExport,nodeRootRebate,nodeRootSelectionBar,nodeBarKo,nodeBarKsr,
			nodeBarM; 
	...
	public void createMainFrame() {
		...
		jmListSaveExcel.add(jmiListDetailedSaveExcel = new JRMenuItem("MenuItem.List.Save.Detailed","ListDetailed.jpg"));
		jmListSaveExcel.add(jmiListSummarizedSaveExcel = new JRMenuItem("MenuItem.List.Save.Summarized","ListProject.jpg"));
		jmListSaveExcel.add(jmiListGarnitureSaveExcel = new JRMenuItem("MenuItem.List.Save.Garniture","ListGarniture.jpg"));
		jmList.addSeparator();
		// List - Save Navison
		...
		// View - Print Preview		
		jmPrintPreview.add(jmiPrintPreviewSummarized = new JRMenuItem("MenuItem.View.PrintPreview.Summarized","ListProject.jpg"));
		jmPrintPreview.add(jmiPrintPreviewDetailed = new JRMenuItem("MenuItem.View.PrintPreview.Detailed","ListDetailed.jpg"));
		jmPrintPreview.add(jmiPrintPreviewGarniture = new JRMenuItem("MenuItem.View.PrintPreview.Garniture","ListGarniture.jpg"));
		// Print
		...
		pnMenuPanel.add(jlMainDatabaseName = new JLabel("...", new ImageIcon(swc.iconPath+"DataBase.jpg"),JLabel.RIGHT));
		...
		tbMDK = new ToolBarButton("","MDK");groupTypes.add(tbMDK);
		tbMDF = new ToolBarButton("","MDF");groupTypes.add(tbMDF);
		tbMDS = new ToolBarButton("","MDS");groupTypes.add(tbMDS);
		tbMKIPP = new ToolBarButton("","MKIPP");groupTypes.add(tbMKIPP);
		tbMDK2 = new ToolBarButton("","MDK2");groupTypes.add(tbMDK2);
		tbMDF2 = new ToolBarButton("","MDF2");groupTypes.add(tbMDF2);
		tbMDS2 = new ToolBarButton("","MDS2");groupTypes.add(tbMDS2);
		tbMFREI = new ToolBarButton("","MFREI");groupTypes.add(tbMFREI);
		tbMDSMDK2 = new ToolBarButton("","MDSMDK2");groupTypes.add(tbMDSMDK2);
		tbMDSMDF2 = new ToolBarButton("","MDSMDF2");groupTypes.add(tbMDSMDF2);
...
//		jtLeftToolBar.setPreferredSize(new Dimension(swc.menuToolbarWidth, swc.menuToolbarHeight));
		...
		jpColors.add(jmiColorOliveBrown = new JRMenuItem("ToolBarButton.OliveBrown.ToolTipText","ColorOliveBrown.jpg"));
		...
		jpColors.add(jmiColorMiddleBrass = new JRMenuItem("ToolBarButton.MiddleBrass.ToolTipText","ColorMiddleBrass.jpg"));
		jpColors.add(jmiColorNatureSilver = new JRMenuItem("ToolBarButton.NatureSilver.ToolTipText","ColorNatureSilver.jpg"));
		...
		jpColors.add(jmiColorCreamWhite = new JRMenuItem("ToolBarButton.CreamWhite.ToolTipText","ColorCreamWhite.jpg"));
		...
		jtCollection.getColumnModel().getColumn(0).setPreferredWidth(30);
		jtCollection.getColumnModel().getColumn(1).setPreferredWidth(50);
		jtCollection.getColumnModel().getColumn(2).setPreferredWidth(350);
		...
		jtCollection.getColumnModel().getColumn(3).setCellRenderer(renderer);
		jtCollection.getColumnModel().getColumn(4).setCellRenderer(renderer);
		jtCollection.getColumnModel().getColumn(5).setCellRenderer(renderer);
		...
		c.gridx = 0;
		c.gridy = 0;
		pnLoginLeft.add(new JLabel(propertyUtil.getLangText("Frame.Label.UserName")+ "  ",new ImageIcon(swc.iconPath + "TreeProfiles.jpg"),JLabel.LEFT),c);
		c.gridx = 1;
		pnLoginLeft.add(tfUser,c);
		c.gridy = 1;
		c.gridx = 0;
		pnLoginLeft.add(new JLabel(" " +propertyUtil.getLangText("Frame.Label.ProfileName")+"  ",new ImageIcon(swc.iconPath + "TreeProfile.jpg"),JLabel.LEFT),c);
		c.gridx = 1;
		...
		canvas.setLabels(jntWidth, jntWidth2, jntHeight, jntHeight2, jntCorrectionWidth, jntCorrectionHeight, jntGarniture);
				
		//Create tabs
		mainTabPane = new JTabbedPane();
		mainTabPane.addTab(propertyUtil.getLangText("Frame.Main.Tab.Login"), new ImageIcon(swc.iconPath + "Login.jpg") , pnLoginTab);
		mainTabPane.addTab(propertyUtil.getLangText("Frame.Main.Tab.Resize"), new ImageIcon(swc.iconPath + "Resize.jpg") , pnResize);
		mainTabPane.addTab(propertyUtil.getLangText("Frame.Main.Tab.Collate"), new ImageIcon(swc.iconPath + "Collate.jpg") , pnCollate);
		mainTabPane.addTab(propertyUtil.getLangText("Frame.Main.Tab.Menus"), new ImageIcon(swc.iconPath + "TabMenu.jpg") , mainDeskTop);
	...
	public void createInternalFrame_PriceListSelect(){
		...
		jtPriceListSelect.getColumnModel().getColumn(0).setPreferredWidth(50);
		jtPriceListSelect.getColumnModel().getColumn(1).setPreferredWidth(380);
	...
	public void createInternalFrame_MaterialGroups()   {
       ...
       pnGroupNameButtons.add(jbGroupNameAdd = new JButton(propertyUtil.getLangText("InternalFrame.MaterialGroups.Button.GroupName.Add")));
       pnGroupNameButtons.add(jbGroupNameModify = new JButton(propertyUtil.getLangText("InternalFrame.MaterialGroups.Button.GroupName.Modify")));
       pnGroupNameButtons.add(jbGroupNameDelete = new JButton(propertyUtil.getLangText("InternalFrame.MaterialGroups.Button.GroupName.Delete")));
       ...
       pnGroupButtons.add(jbGroupAdd = new JButton(propertyUtil.getLangText("InternalFrame.MaterialGroups.Button.Group.Add")));
       pnGroupButtons.add(jbGroupModify = new JButton(propertyUtil.getLangText("InternalFrame.MaterialGroups.Button.Group.Modify")));
       pnGroupButtons.add(jbGroupDelete = new JButton(propertyUtil.getLangText("InternalFrame.MaterialGroups.Button.Group.Delete")));
       ...
       //Bottom panel
       pnGroupsButtons.add(jbGroupReload = new JButton(propertyUtil.getLangText("InternalFrame.MaterialGroups.Button.Group.Reload")));
       pnGroupsButtons.add(jbGroupSave = new JButton(propertyUtil.getLangText("InternalFrame.MaterialGroups.Button.Group.Save")));
	...
	public void createInternalFrame_Menus(){
		...
		pnDirectionTop.add(new JLabel(propertyUtil.getLangText("InternalFrame.Menus.Direction") ,new ImageIcon(swc.iconPath + "Types.jpg"),JLabel.LEFT));
		...
		pnHandle.add(new JLabel(propertyUtil.getLangText("InternalFrame.Menus.Handle") ,new ImageIcon(swc.iconPath + "Handle.jpg"),JLabel.LEFT));
		...
		pnLiftingMD.add(new JLabel(propertyUtil.getLangText("InternalFrame.Menus.LiftingMD") ,new ImageIcon(swc.iconPath + "LiftingMD.jpg"),JLabel.LEFT));
		...
		pnCatchTop.add(new JLabel(propertyUtil.getLangText("InternalFrame.Menus.Catch.Normal") ,new ImageIcon(swc.iconPath + "CatchMagnet.jpg"),JLabel.LEFT));
		...
		pnCatchBottom.add(jrMagnetCatch = new JRadioButton(propertyUtil.getLangText("InternalFrame.Menus.Catch.Magnet")));
		
		jrMagnetCatch.setBackground(Color.WHITE);
		pnCatchBottom.add(new JLabel(new ImageIcon(swc.iconPath + "Catch.jpg"),JLabel.LEFT));
		pnCatchBottom.add(jrNormalCatch = new JRadioButton(propertyUtil.getLangText("InternalFrame.Menus.Catch.Normal"),true));
		...
		pnFan.add(new JLabel(propertyUtil.getLangText("InternalFrame.Menus.Fan") ,new ImageIcon(swc.iconPath + "Fan.jpg"),JLabel.LEFT));
		...
		pnBar.add(new JLabel(propertyUtil.getLangText("InternalFrame.Menus.Bar") ,new ImageIcon(swc.iconPath + "Bar.jpg"),JLabel.LEFT));
		pnBar.add(jrClosableBar= new JRadioButton());
		jrClosableBar.setBackground(Color.WHITE);
		pnBar.add(new JLabel(propertyUtil.getLangText("InternalFrame.Menus.ClosableBar") ,new ImageIcon(swc.iconPath + "ClosableBar.jpg"),JLabel.LEFT));
		...
		pnLock.add(new JLabel(propertyUtil.getLangText("InternalFrame.Menus.Lock") ,new ImageIcon(swc.iconPath + "Lock.jpg"),JLabel.LEFT));
		...
		pnColor.add(new JLabel(propertyUtil.getLangText("InternalFrame.Menus.Colors") ,new ImageIcon(swc.iconPath + "Colors.jpg"),JLabel.LEFT));
		jcbColors = new JComboBox();
		pnColor.add(jcbColors);
				
		Iterator it = propertyUtil.getColorMap().entrySet().iterator();
		while (it.hasNext()) {
	...
	public void createInternalFrame_Rebate(){
		...
		jtCustomPriceList.getColumnModel().getColumn(0).setPreferredWidth(100);
		jtCustomPriceList.getColumnModel().getColumn(1).setPreferredWidth(350);
		jtCustomPriceList.getColumnModel().getColumn(2).setPreferredWidth(80);
		...
		pnCustomPriceListButtons.add(jbCustomPriceListAdd = new JButton(new ImageIcon(swc.iconPath+"\\Plus.jpg")),"North");
		pnCustomPriceListButtons.add(jbCustomPriceListRemove = new JButton(new ImageIcon(swc.iconPath+"\\Minus.jpg")),"South");
		...
		jtRebate.getColumnModel().getColumn(0).setPreferredWidth(60);
		jtRebate.getColumnModel().getColumn(1).setMaxWidth(40);
		...
		jtRebate.getColumnModel().getColumn(1).setCellEditor(cellEditor);
		...
		jtRebateGroups.getColumnModel().getColumn(1).setPreferredWidth(130);
		jtRebateGroups.getColumnModel().getColumn(2).setMaxWidth(40);
		...
		jtRebateGroups.getColumnModel().getColumn(2).setCellEditor(groupCellEditor);
		...
		c.gridy = 7;
		pnRebateAdmin.add(jbAdminRebateSave = new JButton(propertyUtil.getLangText("InternalFrame.Rebate.Admin.Save")),c);
		c.gridy = 8;
		pnRebateAdmin.add(jbAdminRebateOpen = new JButton(propertyUtil.getLangText("InternalFrame.Rebate.Admin.Open")),c);
	...
	public void createInternalFrame_DatabaseListEditor(){
		jriDbListEditor = new JRInternalFrame("DataBaseListEditor", "InternalFrame.DatabaseListEditor.Title", mainDeskTop);
		...
		pnDatabases.add(jbDbListBrowse = new JButton(propertyUtil.getLangText("InternalFrame.DatabaseListEditor.Button.Browse")),"South");
		...
		pnDatabaseFilter.add(jbDbListOpen = new JButton(propertyUtil.getLangText("InternalFrame.DatabaseListEditor.Button.Open")),"South");
	...
	public void createInternalFrame_AdminLogin(){
		jriAdminLogin = new JRInternalFrame("AdminLogin", propertyUtil.getLangText("InternalFrame.AdminLogin.Title"), mainDeskTop);
	...
	public void createInternalFrame_Windows(){
		...
		windowTabPane.addTab(propertyUtil.getLangText("InternalFrame.Windows.Limits"),
				new JScrollPane(jtWindowLimits));
		pnWindows.add(windowTabPane,"Center");
		
		jtWindows.getColumnModel().getColumn(0).setPreferredWidth(100);
		jtWindows.getColumnModel().getColumn(5).setPreferredWidth(230);
		jtWindows.getColumnModel().getColumn(6).setPreferredWidth(180);
		...
		jtWindows.getColumnModel().getColumn(1).setCellRenderer(renderer);
		jtWindows.getColumnModel().getColumn(6).setCellRenderer(renderer);
		jtWindowLimits.getColumnModel().getColumn(1).setCellRenderer(renderer);
		...
		pnWindowSystemsDirections.add(jbWindowsLeft = new JButton(new ImageIcon(swc.iconPath+"MoveLeft.jpg")),"West");
		pnWindowSystemsDirections.add(jbWindowsRight = new JButton(new ImageIcon(swc.iconPath+"MoveRight.jpg")),"East");
	...
	public void createInternalFrame_ExcelList(){
		...
		//Create buttons 
		pnButtons.add(jbSaveExcelList = new JButton(propertyUtil.getLangText("InternalFrame.ExcelList.Buttons.Save"),new ImageIcon(swc.iconPath + "Excel.jpg")));
		jbSaveExcelList.setMargin(new Insets(0,2,0,2));
		pnButtons.add(jbPrintExcelList = new JButton(propertyUtil.getLangText("InternalFrame.ExcelList.Buttons.Print"),new ImageIcon(swc.iconPath + "Print.jpg")));
		...
		//Create header types
		pnHeaderSelector.add(jrOrder = new JRadioButton(propertyUtil.getLangText("InternalFrame.ExcelList.Header.Subject.Order.Default"),true));
		pnHeaderSelector.add(jrOffer = new JRadioButton(propertyUtil.getLangText("InternalFrame.ExcelList.Header.Subject.Offer.Default")));
		...
		jtExcelList.getColumnModel().getColumn(0).setPreferredWidth(30);
		jtExcelList.getColumnModel().getColumn(1).setPreferredWidth(50);
		jtExcelList.getColumnModel().getColumn(2).setPreferredWidth(350);
		
		jtExcelList.getColumnModel().getColumn(3).setCellRenderer(renderer);
		jtExcelList.getColumnModel().getColumn(4).setCellRenderer(renderer);
		jtExcelList.getColumnModel().getColumn(5).setCellRenderer(renderer);
	...
	public void createInternalFrame_CollectionList(){
		...
		jtCollectionList.getColumnModel().getColumn(0).setPreferredWidth(30);
		jtCollectionList.getColumnModel().getColumn(1).setPreferredWidth(50);
		jtCollectionList.getColumnModel().getColumn(2).setPreferredWidth(350);
		
		jtCollectionList.getColumnModel().getColumn(3).setCellRenderer(renderer);
		jtCollectionList.getColumnModel().getColumn(4).setCellRenderer(renderer);
		jtCollectionList.getColumnModel().getColumn(5).setCellRenderer(renderer);
	...
	public void createInternalFrame_CollectionEdit(){
		...
		jtCollectionEdit.getColumnModel().getColumn(0).setCellEditor(cellEditor);
		
		jtCollectionEdit.getColumnModel().getColumn(0).setPreferredWidth(30);
		jtCollectionEdit.getColumnModel().getColumn(1).setPreferredWidth(50);
		jtCollectionEdit.getColumnModel().getColumn(2).setPreferredWidth(340);
		
		jtCollectionEdit.getColumnModel().getColumn(3).setCellRenderer(renderer);
		jtCollectionEdit.getColumnModel().getColumn(4).setCellRenderer(renderer);
		jtCollectionEdit.getColumnModel().getColumn(5).setCellRenderer(renderer);
		...
		pnCollectionListButtons.add(jbCollectionEditAdd = new JButton(new ImageIcon(swc.iconPath+"\\Plus.jpg")),"North");
		pnCollectionListButtons.add(jbCollectionEditRemove = new JButton(new ImageIcon(swc.iconPath+"\\Minus.jpg")),"South");

		//Create counter buttons on table gird
		pnCollectionCounterButtons.add(jbCollectionEditIncrease = new JButton(new ImageIcon(swc.iconPath+"\\Increase.jpg")),"North");
		pnCollectionCounterButtons.add(jbCollectionEditDecrease = new JButton(new ImageIcon(swc.iconPath+"\\Decrease.jpg")),"South");
	...
	public void createInternalFrame_ReplaceData(){
		...
		pnBottom.add(jrReplaceText = new JRadioButton(propertyUtil.getLangText("InternalFrame.ReplaceData.ReplaceText.Title")));
		pnBottom.add(jrReplaceSAP = new JRadioButton(propertyUtil.getLangText("InternalFrame.ReplaceData.ReplaceSAP.Title"),true));
	...
	public void createInternalFrame_LanguagesEdit(){
		...
		pnBottom.add(jbLanguageEditorAdd = new JButton(propertyUtil.getLangText("Frame.Canvas.Button.AddCollection"),new ImageIcon(swc.iconPath+"Plus.jpg")),c);
		c.gridx =1;
		pnBottom.add(jbLanguageEditorSave = new JButton(propertyUtil.getLangText("InternalFrame.LanguagesEdit.Save"),new ImageIcon(swc.iconPath+"Save.jpg")),c);
	...
	public void createInternalFrame_StockList(){
		...
		for (int i=0; i < swc.colorTitles.length; i++){
			CheckNode node = new CheckNode(propertyUtil.getLangText("Color." + swc.colorTitles[i])+ " ["+ swc.colorArray[i] +"]");
			node.setSelected(i==0);
		...
		jtStockList.getColumnModel().getColumn(0).setMaxWidth(55);
		jtStockList.getColumnModel().getColumn(1).setMaxWidth(60);
		jtStockList.getColumnModel().getColumn(3).setMaxWidth(120);
		...
		pnFileListButtonsDelete.add(jbStockRemoveFile = new JButton(new ImageIcon(swc.iconPath+"Minus.jpg")),"South");
	...
	public void createInternalFrame_Profiles(){
		...
		pnProfilesLeft.add(jbProfileAssembly = new JButton(propertyUtil.getLangText("InternalFrame.Profiles.Button.Assembly")),"South");
		jbProfileAssembly.setPreferredSize(new Dimension(175,25));
		
		//Left panel
		pnProfilesRight.add(new JScrollPane(exportTree),"Center");
		pnProfilesRight.add(jbProfileExport = new JButton(propertyUtil.getLangText("InternalFrame.Profiles.Button.Export")),"South");
	...
	public void createInternalFrame_Register(){
		...
		pnLeft.add(jbRegisterSaveForm = new JButton(propertyUtil.getLangText("InternalFrame.Register.SaveForm"), new ImageIcon(swc.iconPath + "Save.jpg")));
		pnLeft.add(jbRegisterOpenForm = new JButton(propertyUtil.getLangText("InternalFrame.Register.OpenForm"), new ImageIcon(swc.iconPath + "Open.jpg")));
		pnLeft.add(new JLabel());
		pnLeft.add(new JLabel());
		pnLeft.add(new JLabel());
		pnLeft.add(jbRegisterDemo = new JButton(propertyUtil.getLangText("InternalFrame.Register.Demo"), new ImageIcon(swc.iconPath + "Demo.jpg")));
		pnLeft.add(jbRegisterNewKey = new JButton(propertyUtil.getLangText("InternalFrame.Register.NewKey"), new ImageIcon(swc.iconPath + "NewKey.jpg")));
		pnLeft.add(jbRegister = new JButton(propertyUtil.getLangText("InternalFrame.Register.Registration"), new ImageIcon(swc.iconPath + "Registration.jpg")));
		pnLeft.add(new JLabel());
		pnLeft.add(new JLabel());
		pnLeft.add(jbRegisterExit = new JButton(propertyUtil.getLangText("InternalFrame.Register.Exit"), new ImageIcon(swc.iconPath + "Exit.jpg")));
		...
		pnRightBottom.add(tfRegCompanyTitle = new JTextField(propertyUtil.getLangText("InternalFrame.Register.Form.CompanyName") + ":"));
		pnRightBottom.add(tfRegCompany = new JTextField(""));
		pnRightBottom.add(tfRegAddressTitle = new JTextField(propertyUtil.getLangText("InternalFrame.Register.Form.Address") + ":"));
		pnRightBottom.add(tfRegAddress = new JTextField(""));
		pnRightBottom.add(tfRegOperatorTitle = new JTextField(propertyUtil.getLangText("InternalFrame.Register.Form.Operator") + ":"));
		pnRightBottom.add(tfRegOperator = new JTextField(""));
		pnRightBottom.add(tfRegEmailTitle = new JTextField(propertyUtil.getLangText("InternalFrame.Register.Form.Email") + ":"));
		pnRightBottom.add(tfRegEmail = new JTextField(""));
		pnRightBottom.add(tfRegSalesRepTitle = new JTextField(propertyUtil.getLangText("InternalFrame.Register.Form.SalesRep") + ":"));
		pnRightBottom.add(tfRegSalesRep = new JTextField(""));
		pnRightBottom.add(tfRegCommentTitle = new JTextField(propertyUtil.getLangText("InternalFrame.Register.Form.Comment") + ":"));
	...
	public void dragGestureRecognized(DragGestureEvent dge) {
		if (dge.getComponent().getName().toLowerCase().equalsIgnoreCase("databaselist")){
		...
		} else if (dge.getComponent().getName().toLowerCase().equalsIgnoreCase("databasefilterlist") && dlDatabaseFilter.size()>0){
