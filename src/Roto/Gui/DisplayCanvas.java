...
public class DisplayCanvas extends JPanel implements MouseListener {
    ...
    private static final long serialVersionUID = 1005645918900132856L;
    ...
    private Image image;
    private JLabel jlColorNone, jlWhite, jlBrown, jlTitan, jlNewSilver, jlNatureSilver, jlGold, jlMatGold, jlBrass, jlLeft, jlRight, jlOver, jlHandle, jlLiftingMd, jlCatchNone, jlCatch, jlCatchMagnet, jlFan, jlCilinder, jlDragImage, jlHandleNone, jlLiftingMdNone, jlFanNone, jlCilinderNone, jlOliveBrown, jlGreyBrown, jlMiddleBrass, jlDarkBrass, jlCreamWhite, jlJetBlack;
    ...
    public void setLabels(JRNumberTextField labelWidth, JRNumberTextField labelWidth2, JRNumberTextField labelHeight,
                          JRNumberTextField labelHeight2, JRNumberTextField labelCorrectionWidth,
                          JRNumberTextField labelCorrectionHeight, JRNumberTextField labelGarniture) {
    ...
    private void createGUI() {
        ...
        labelList.add(createCanvasLabel(jlLeft, "jlLeft", "Left.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Left.ToolTipText")));
        labelList.add(createCanvasLabel(jlRight, "jlRight", "Right.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Right.ToolTipText")));
        labelList.add(createCanvasLabel(jlOver, "jlOver", "Over.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Over.ToolTipText")));

        labelList.add(createCanvasLabel(jlCatchNone, "jl_CatchNone", "CatchNone.jpg",
                                        propertyUtil.getLangText("ToolBarButton.CatchNone.ToolTipText")));
        labelList.add(createCanvasLabel(jlCatch, "jl_Catch", "Catch.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Catch.ToolTipText")));
        labelList.add(createCanvasLabel(jlCatchMagnet, "jl_CatchMagnet", "CatchMagnet.jpg",
                                        propertyUtil.getLangText("ToolBarButton.CatchMagnet.ToolTipText")));

        labelList.add(createCanvasLabel(jlHandleNone, "jl_HandleNone", "HandleNone.jpg",
                                        propertyUtil.getLangText("ToolBarButton.HandleNone.ToolTipText")));
        labelList.add(createCanvasLabel(jlHandle, "jl_Handle", "Handle.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Handle.ToolTipText")));
        labelList.add(new JLabel());

        labelList.add(createCanvasLabel(jlLiftingMdNone, "jl_LiftingMdNone", "LiftingMDNone.jpg",
                                        propertyUtil.getLangText("ToolBarButton.LiftingMDNone.ToolTipText")));
        labelList.add(createCanvasLabel(jlLiftingMd, "jl_LiftingMd", "LiftingMD.jpg",
                                        propertyUtil.getLangText("ToolBarButton.LiftingMD.ToolTipText")));
        labelList.add(new JLabel());

        labelList.add(createCanvasLabel(jlFanNone, "jl_FanNone", "FanNone.jpg",
                                        propertyUtil.getLangText("ToolBarButton.FanNone.ToolTipText")));
        labelList.add(createCanvasLabel(jlFan, "jl_Fan", "Fan.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Fan.ToolTipText")));
        labelList.add(new JLabel());

        jlBar =
            createCanvasLabel(jlBar, "jl_Bar", "Bar.jpg", propertyUtil.getLangText("ToolBarButton.Bar.ToolTipText"));
        labelList.add(jlBar);
        jlClosableBar =
            createCanvasLabel(jlClosableBar, "jl_ClosableBar", "ClosableBar.jpg",
                              propertyUtil.getLangText("ToolBarButton.ClosableBar.ToolTipText"), "25");
        labelList.add(jlClosableBar);
        jlSelectionBar =
            createCanvasLabel(jlSelectionBar, "jl_SelectionBar", "Bar.jpg",
                              propertyUtil.getLangText("ToolBarButton.SelectionBar.ToolTipText"), "K");
        labelList.add(jlSelectionBar);
        jlNT =
            createCanvasLabel(jlNT, "jl_NT", "NT.jpg", propertyUtil.getLangText("ToolBarButton.NT.ToolTipText"),
                              "3/100");
        labelList.add(jlNT);
        jlNX =
            createCanvasLabel(jlNX, "jl_NX", "NX.jpg", propertyUtil.getLangText("ToolBarButton.NX.ToolTipText"),
                              "3/130");
        labelList.add(jlNX);
        labelList.add(new JLabel());

        labelList.add(createCanvasLabel(jlCilinderNone, "jl_CilinderNone", "LockNone.jpg",
                                        propertyUtil.getLangText("ToolBarButton.CilinderNone.ToolTipText")));
        labelList.add(createCanvasLabel(jlCilinder, "jl_Cilinder", "Lock.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Cilinder.ToolTipText")));
        labelList.add(new JLabel());

        labelList.add(createCanvasLabel(jlColorNone, "jl_colornone", "ColorNone.jpg",
                                        propertyUtil.getLangText("ToolBarButton.ColorNone.ToolTipText")));
        labelList.add(createCanvasLabel(jlWhite, "jl_colorwhite", "ColorWhite.jpg",
                                        propertyUtil.getLangText("ToolBarButton.White.ToolTipText")));
        labelList.add(createCanvasLabel(jlBrown, "jl_colorbrown", "ColorBrown.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Brown.ToolTipText")));
        labelList.add(createCanvasLabel(jlOliveBrown, "jl_colorolivebrown", "ColorOliveBrown.jpg",
                                        propertyUtil.getLangText("ToolBarButton.OliveBrown.ToolTipText")));
        labelList.add(createCanvasLabel(jlGreyBrown, "jl_colorgreybrown", "ColorGreyBrown.jpg",
                                        propertyUtil.getLangText("ToolBarButton.GreyBrown.ToolTipText")));
        labelList.add(createCanvasLabel(jlMatGold, "jl_colormatgold", "ColorMatGold.jpg",
                                        propertyUtil.getLangText("ToolBarButton.MatGold.ToolTipText")));
        labelList.add(createCanvasLabel(jlGold, "jl_colorgold", "ColorGold.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Gold.ToolTipText")));
        labelList.add(createCanvasLabel(jlTitan, "jl_colortitan", "ColorTitan.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Titan.ToolTipText")));
        labelList.add(createCanvasLabel(jlBrass, "jl_colorbrass", "ColorBrass.jpg",
                                        propertyUtil.getLangText("ToolBarButton.Brass.ToolTipText")));
        labelList.add(createCanvasLabel(jlMiddleBrass, "jl_colormiddlebrass", "ColorMiddleBrass.jpg",
                                        propertyUtil.getLangText("ToolBarButton.MiddleBrass.ToolTipText")));
        labelList.add(createCanvasLabel(jlNatureSilver, "jl_colornaturesilver", "ColorNatureSilver.jpg",
                                        propertyUtil.getLangText("ToolBarButton.NatureSilver.ToolTipText")));
        labelList.add(createCanvasLabel(jlNewSilver, "jl_colornewsilver", "ColorNewSilver.jpg",
                                        propertyUtil.getLangText("ToolBarButton.NewSilver.ToolTipText")));
        labelList.add(createCanvasLabel(jlDarkBrass, "jl_colordarkbrass", "ColorDarkBrass.jpg",
                                        propertyUtil.getLangText("ToolBarButton.DarkBrass.ToolTipText")));
        labelList.add(createCanvasLabel(jlCreamWhite, "jl_colorcreamwhite", "ColorCreamWhite.jpg",
                                        propertyUtil.getLangText("ToolBarButton.CreamWhite.ToolTipText")));
        labelList.add(createCanvasLabel(jlJetBlack, "jl_colorjetblack", "ColorJetBlack.jpg",
                                        propertyUtil.getLangText("ToolBarButton.JetBlack.ToolTipText")));

        createCanvasToolBarLeft(labelList, canvasToolBarX, canvasToolBarY, new Dimension(30, 30));

        pnWarning.setBounds(125, 35, 30, 30);
    ...
    private JLabel createCanvasLabel(JLabel label, String labelName, final String imageName, String toolTipText,
