...
public class WindowComponents {
    ...
    final static BasicStroke dashed =
        new BasicStroke(0.3f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 3.0f, dash1, 0.0f);
    final static BasicStroke dashedBold =
        new BasicStroke(0.6f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 3.0f, dash1, 0.0f);
    ...
    public void setLabels(JRNumberTextField jntWidth, JRNumberTextField jntWidth2, JRNumberTextField jntHeight,
                          JRNumberTextField jntHeight2) {
    ...
    public void drawCilinder(int horizontalModify) {
        ...
        if ((isLeft || isOver) && !isTopPosition) {
            g2.drawImage(createImage("CanvasCilinder.gif"), x + width + 10, y + height / 2 + 70 + horizontalModify,
                         null);
            g2.setStroke(dashed);
            g2.drawLine(x + width - 50, y + 202 + horizontalModify, x + width + 15,
                        y + height / 2 + 85 + horizontalModify);
    ...
    public void drawHandle(int horizontalModifyCilinderHole) {
        ...
        if ((isLeft || isOver) && !isTopPosition) {
            ...
            if (isClosable) {
                ...
                g2.drawImage(createImage("CanvasHandleGarniture.gif"), x + width + 6,
                             y + height / 2 + 40 + horizontalModifyCilinderHole, null);
                g2.setStroke(dashed);
                g2.drawLine(x + width - 7, y + height / 2 + 22 + horizontalModifyCilinderHole, x + width + 6,
                            y + height / 2 + 45 + horizontalModifyCilinderHole);
            }
            g2.setStroke(dashed);
        ...
        if ((isRight || isOver) && !isTopPosition) {
            ...
            if (isClosable) {
                ...
                g2.drawImage(createImage("CanvasHandleGarniture.gif"), x - 18,
                             y + height / 2 + 40 + horizontalModifyCilinderHole, null);
                g2.setStroke(dashed);
                g2.drawLine(x + 8, y + height / 2 + 22 + horizontalModifyCilinderHole, x - 12,
                            y + height / 2 + 45 + horizontalModifyCilinderHole);
            }
            g2.setStroke(dashed);
    ...
    public void drawLineDashed(float lineWidth, int x1, int y1, int x2, int y2) {
        ...
        g2.setPaint(Color.BLACK);
        BasicStroke dashed =
            new BasicStroke(lineWidth, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 3.0f, dash1, 0.0f);
        g2.setStroke(dashed);
        g2.drawLine(x1, y1, x2, y2);
    }
    ...
    public void drawFrameSegment(float lineWidth, String direction) {
        ...
        if (direction.toLowerCase().equalsIgnoreCase("center")) {
            ...
            if (lineWidth != 0)
                g2.setStroke(new BasicStroke(lineWidth));
            q.setCurve(locationX, y + arcStartHeight, x + arcWidth / 2, y - arcStartHeight, x + arcWidth,
                       y + arcStartHeight);
            g2.draw(q);
            q.setCurve(locationX + 15, y + arcStartHeight + 15, x + arcWidth / 2, y - arcStartHeight + 22,
                       x + arcWidth - 15, y + arcStartHeight + 15);
            g2.draw(q);
            g2.setStroke(new BasicStroke(1));
            if (lineWidth != 0)
                g2.setStroke(new BasicStroke(lineWidth));
            q.setCurve(locationX + 19, y + arcStartHeight + 19, x + arcWidth / 2, y - arcStartHeight + 28,
                       x + arcWidth - 19, y + arcStartHeight + 19);
            g2.draw(q);
            ...
            g2.draw(q);
            q.setCurve(locationX + 15, y + arcStartHeight + 12, x + arcWidth / 2 - 10, y + 18, x + arcWidth - 19,
                       y + 15);
            g2.draw(q);
            g2.setStroke(new BasicStroke(1));
            if (lineWidth != 0)
                g2.setStroke(new BasicStroke(lineWidth));
            q.setCurve(locationX + 19, y + arcStartHeight + 15, x + arcWidth / 2 - 10, y + 24, x + arcWidth - 19,
                       y + 19);
            ...
            g2.draw(q);
            q.setCurve(locationX + 15, y + 15, x + arcWidth / 2 + 15, y + 22, x + arcWidth - 15,
                       y + arcStartHeight + 12);
            g2.draw(q);
            g2.setStroke(new BasicStroke(1));
            if (lineWidth != 0)
                g2.setStroke(new BasicStroke(lineWidth));
            q.setCurve(locationX + 19, y + 19, x + arcWidth / 2 + 15, y + 28, x + arcWidth - 19,
                       y + arcStartHeight + 14);
    ...
    public void drawSize(String direction, boolean secondWidth, boolean secondHeight, boolean isArc) {
        ...
        if (!isArc) {
            g2.drawRect(x, y + height, width, 30);
        } else {
        ...
        if (!secondWidth) {
            if (direction.toLowerCase()
                ...
                g2.drawLine(x + width + hegihtSizeDistance, y, x + width + hegihtSizeDistance + 2, y + 5);
                g2.drawLine(x + width + hegihtSizeDistance, y, x + width + hegihtSizeDistance - 2, y + 5);
                g2.drawLine(x + width + hegihtSizeDistance, y + height, x + width + hegihtSizeDistance + 2,
                            y + height - 5);
                g2.drawLine(x + width + hegihtSizeDistance, y + height, x + width + hegihtSizeDistance - 2,
                            y + height - 5);
    ...
    public void setSize(int width, int height) {
        ...
        if (x + width > windowHit.width)
            windowHit.width = x + width;
        if (y + height > windowHit.height)
            windowHit.height = y + height;
    }
