...
public class WindowTableModel extends AbstractTableModel {
    ...
    private String[] columnNames = {propertyUtil.getLangText("InternalFrame.Windows.Enabled"),
    								propertyUtil.getLangText("InternalFrame.Windows.Type"),
    								propertyUtil.getLangText("InternalFrame.Windows.Left"),
    								propertyUtil.getLangText("InternalFrame.Windows.Right"),
    								propertyUtil.getLangText("InternalFrame.Windows.Over"),
    								propertyUtil.getLangText("InternalFrame.Windows.Key"),
    								propertyUtil.getLangText("InternalFrame.Windows.Value")};
